...
for m in list_month: 
    ...
    ax.set_title('Outaouais Watershed: '+ month.capitalize() , fontdict={'fontsize': 20, 'fontweight': 'bold'})
    ...
    plt.savefig(('Precipitation_Daily_by_TMAXBins_All_points_'+month+'_'+str(futi)+'-'+str(futf)+'.png'), dpi=300, bbox_inches='tight')
