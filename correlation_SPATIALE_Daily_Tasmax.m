...
%% 
path_daymet='K:\PROJETS\PROJET_OUTAOUAIS\Daily\tmax\';
...
for t=1:12 
 ...
 FichierIn = char ( strcat(path_daymet,'Daymet_v3_Daily_Tasmax_1990_2019_',char(mois),'_OUTAOUAIS.nc' ));
 ...
 FichierIn = char ( strcat(path_era5,'ERA5grid_Daily_Tasmax_1990_2019_',char(mois),'_OUTAOUAIS.nc' ));
 ncid = netcdf.open(FichierIn,'NC_NOWRITE');
...
filenc= char ( strcat(out,'Daymet_v3_spearmann_Correlation_ERA5grid_Daily_Tasmax_1990_2019_',char(mois) ,'_OUTAOUAIS_matlab.nc' ));
