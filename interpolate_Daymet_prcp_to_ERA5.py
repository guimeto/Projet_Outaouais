...
path_source = './Daymet_Month_Indices/MOY/'
...
source = xr.open_dataset(path_source + 'Daymet_v3_Monthly_Mean_Prcp_199001_OUTAOUAIS.nc')
...
for year in range(yi,yf+1):
    for i in range (1,13,1):  
        ...
        data_set = xr.Dataset( coords={'lon': ([ 'lon'], lon_target),
                                             'lat': (['lat',], lat_target)})
        data_set["Mean_Prcp"] = (['lat', 'lon'],  pcp_idw)
